...
`r fontawesome::fa(name = "link", fill = "#666666")`](https://jauntyjjs.github.io/rugs_20241129){target="_blank"} [`r fontawesome::fa(name = "github", fill = "#000000")`](https://github.com/JauntyJJS/rugs_20241129){target="_blank"} [`r fontawesome::fa(name = "file-pdf", fill = "#b50b00")`](https://raw.githubusercontent.com/JauntyJJS/rugs_20241129/main/index.pdf){target="_blank"}
...
* [Quarto Dashboard Documentation `r fontawesome::fa(name = "book", fill = "#77acdf")`](https://quarto.org/docs/dashboards/){target="_blank"}
* [Quarto Resources from Isabella Velásquez `r fontawesome::fa(name = "github", fill = "#000000")`](https://github.com/ivelasq/2024-07-18_quarto-dashboards){target="_blank"}
* Quarto Dashboard Tutorial Videos from Mine Çetinkaya-Rundel
  * [1: Hello, Dashboards! `r fontawesome::fa(name = "youtube", fill = "#ff0034")`](https://www.youtube.com/watch?v=HW7QbqI4fH0){target="_blank"}
  * [2: Components `r fontawesome::fa(name = "youtube", fill = "#ff0034")`](https://www.youtube.com/watch?v=KdsQgwaY950){target="_blank"}
  * [3: Theming and Styling `r fontawesome::fa(name = "youtube", fill = "#ff0034")`](https://www.youtube.com/watch?v=NigWSB-jG4Y){target="_blank"}
* Spotify dashboard for 2024 Posit Table Contest submission using Quarto from Melissa Van Bussel
  ...
  * [Source Code `r fontawesome::fa(name = "github", fill = "#000000")`](https://github.com/melissavanbussel/spotify-dashboard){target="_blank"}
  * [Spotify Dashboard `r fontawesome::fa(name = "list", fill = "#17d75e")`](https://melissavanbussel.github.io/spotify-dashboard/dashboard.html){target="_blank"}
